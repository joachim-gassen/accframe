...
BOTEX_DB = 'data/exp_runs/gift_botex_db_2024-03-28.sqlite3'
OTREE_DATA = 'data/exp_runs/gift_otree_2024-03-28.csv'
...
def extract_participant_data(otree_raw, exp):
    wide = otree_raw.loc[
        ...
        (otree_raw['participant._index_in_pages'] == 90) 
...
participants = pd.concat([
    extract_participant_data(otree_raw, 'gift'),
    extract_participant_data(otree_raw, 'fgift')
])
rounds = pd.concat([
    extract_round_data(otree_raw, 'gift'),
    extract_round_data(otree_raw, 'fgift')
])
